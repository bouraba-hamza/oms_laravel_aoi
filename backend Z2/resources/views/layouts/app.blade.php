...
<head>
    ...
    <link href="{{ asset('css/assets/global/plugins/morris/morris.csss'}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/assets/global/plugins/fullcalendar/fullcalendar.min.css'}}" rel="stylesheet" type="text/css" />
